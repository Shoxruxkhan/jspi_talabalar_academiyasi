...
mycursor.execute("ALTER TABLE academy.accounts_yunalish CONVERT TO CHARACTER SET utf8")
mycursor.execute("ALTER TABLE academy.accounts_customuser CONVERT TO CHARACTER SET utf8")
